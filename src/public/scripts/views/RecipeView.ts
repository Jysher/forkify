...
class RecipeView extends View {
  ...
  protected parentElement: HTMLElement | null | undefined =
    document.querySelector<HTMLElement>('.recipe');
        ...
        <div class="recipe__ingredients">
          ...
          <ul class="recipe__ingredient-list">
              ...
              this.data.ingredients
                ? this.generateIngredientHTML(this.data.ingredients)
                : ''
            }
          </ul>
        </div>
  ...
  protected generateIngredientHTML(ingredients: Ingredient[]): string {
    return ingredients
      .map(
        (ing: Ingredient) =>
  ...
  public handlerRender(handler: () => void): void {
